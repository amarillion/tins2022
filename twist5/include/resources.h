...
public:
	...
	virtual int addFiles(const char *pattern) = 0;
	virtual int addDir(const char *dir) = 0;
	...
	virtual int addSingleFile(const std::string &i) = 0;
	...
	virtual int addJsonMapFile (const std::string &id, const std::string &filename, const std::string &tilesname) = 0;
	virtual int addJsonMapFile (const std::string &filename, const std::string &tilesname) = 0;
	...
	virtual int addStream(const std::string &id, const std::string &filename) = 0;
	virtual ~Resources() {}
};
